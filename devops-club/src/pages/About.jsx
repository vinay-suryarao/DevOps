...
import { Binoculars, Rocket, HeartHandshake, ChevronLeft, ChevronRight } from 'lucide-react';
...
import Intern1 from '../assets/reg1.jpg';
import Intern2 from '../assets/reg2.jpg';
import Intern3 from '../assets/reg3.jpg';
import Intern4 from '../assets/reg4.jpg';
...
const ImageSlider = () => {
  ...
  const sliderImages = [Intern1, Intern2, Intern3, Intern4, Intern5, Intern6];
  ...
  return (
    <div className="relative group w-full max-w-md aspect-[4/3] md:aspect-video overflow-hidden rounded-xl shadow-xl border-2 border-slate-300 bg-slate-50 flex items-center justify-center">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 top-1/2 -translate-y-1/2 z-30 bg-white/80 hover:bg-orange-500 hover:text-white text-slate-800 p-1.5 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all border border-slate-200"
      >
        <ChevronLeft size={18} />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-2 top-1/2 -translate-y-1/2 z-30 bg-white/80 hover:bg-orange-500 hover:text-white text-slate-800 p-1.5 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all border border-slate-200"
      >
        <ChevronRight size={18} />
      </button>
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex space-x-2 z-30 bg-black/10 px-3 py-1.5 rounded-full backdrop-blur-sm">
