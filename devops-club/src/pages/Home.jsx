...
import redhatimg1 from "../assets/redhat-logo.jpeg"

const redhatEventImages = [
     redhatimg1,
    "https://via.placeholder.com/800x450/cc0000/ffffff?text=Hands-On+Lab",
    "https://via.placeholder.com/800x450/990000/ffffff?text=Expert+Speaker",
    "https://via.placeholder.com/800x450/660000/ffffff?text=Student+Interaction",
];
...
    role: "Assistant Professor at APSIT",
    image: sujataImg,
    skills: ["Git & GitHub", "Software Engineering", "Software Development", "CI/CD", "Kubernetes"],
...
              <img src={coordinator.image} alt={coordinator.name} className="w-full h-full rounded-full object-cover" />
            </div>
...
                <li key={index} className="bg-slate-700 text-sky-300 rounded-full px-4 py-1 text-sm">
                  {skill}
                </li>
              ))}
            </ul>
...
      className={`group flex flex-col md:flex-row items-center gap-8 w-full ${videoPosition === 'right' ? 'md:flex-row-reverse' : ''}`}
    >
      {videoElement}
      {textElement}
    </motion.div>
...
        const newIndex = isFirstImage ? redhatEventImages.length - 1 : currentImageIndex - 1;
...
            APSIT DEVOPS CLUB
          </motion.h1>
          <motion.h2 variants={fadeInUp} className="text-md md:text-lg text-white font-semibold tracking-widest mt-[-10px] md:mt-[-20px] mb-14 uppercase">
            WELCOME TO DEVOPS CLUB
          </motion.h2>
          <motion.div variants={fadeInUp} className="text-4xl md:text-5xl text-white font-bold mb-10 pt-4 max-w-5xl">
...
          >
            <h2 className="text-4xl font-extrabold text-center text-slate-800 mb-8 drop-shadow-[0_2px_2px_rgba(0,0,0,0.1)]">
              Red Hat Event
            </h2>
...
                
                <div className="w-full lg:w-1/2">
                    <h3 className="text-2xl font-bold text-orange-600 mb-3">Event Highlights</h3>
                    <p className="text-slate-700 text-lg leading-relaxed">
                        Our recent collaboration with Red Hat provided an immersive experience into the world of open-source technologies. Students engaged in hands-on workshops, learning about enterprise Linux, containerization with Podman, and automation with Ansible. The event was a huge success, empowering attendees with industry-relevant skills and insights directly from Red Hat certified professionals.
                    </p>
                </div>
            </div>
          </motion.div>
